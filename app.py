...
console_choice = st.selectbox(
    "", # Etichetta standard nascosta per usare il markdown sopra
...
# Condizione 1: Console con lettore integrato
if console_choice in ["PS5 Standard - € 499.99", "PS5 Slim Standard - € 549.99", "PS5 Pro - € 799.99"]:
    show_physical = True

# Condizione 2: Aggiunta del lettore esterno
...
# --- Final Display Result (Highly Prominent) ---
st.markdown("## The switching costs that would be incurred in the event of an asset change, would be :")
# Usa HTML per centrare e ingrandire massicciamente il risultato finale
st.markdown(
